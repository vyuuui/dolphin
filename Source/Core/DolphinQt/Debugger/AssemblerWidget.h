...
private:
  enum class AsmKind
  {
    kRaw, kActionReplay, kGecko, kGeckoExec, kGeckoTrampoline
  };
  constexpr static int kOutputBoxWidth = 18;
  void CreateWidgets();
  void ConnectWidgets();
  ...
  constexpr static int kInvalidEditorNum = -1;
